...
class InvoiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach($invoice_details as $invoice_detail) {
            ...
            // $arDescription = json_decode(file_get_contents('https://translation.googleapis.com/language/translate/v2?key='.$apikey.'&q='.urlencode($invoice_detail['product']).'&target=ar'));
            $_invoice_detail = InvoiceDetail::create([
                ...
                'arabic_description' => $invoice_detail['arabic_description']?$invoice_detail['arabic_description']:json_decode(file_get_contents('https://translation.googleapis.com/language/translate/v2?key='.$apikey.'&q='.urlencode($invoice_detail['product']).'&target=ar')),
