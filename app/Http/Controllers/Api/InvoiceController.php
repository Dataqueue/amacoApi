...
class InvoiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach($invoice_details as $invoice_detail) {
            ...
            $arDescription = $invoice_detail['product']?json_decode(file_get_contents('https://translation.googleapis.com/language/translate/v2?key='.$apikey.'&q='.urlencode($invoice_detail['product']).'&target=ar')):null;
