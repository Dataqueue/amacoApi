...
class DeliveryNoteDetail extends Model
{
    ...
    public function getBalanceQuantity($id, $pid)
    {
        ...
        $latest=DeliveryNoteDetail::where(['delivery_note_id'=>$id,'product_id'=>$pid])->orderBy('created_at','desc')->get('delivered_quantity');
        return $totalDeliveryNoteDetails-$latest->delivered_quantity;
    }
